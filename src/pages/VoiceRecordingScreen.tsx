      ...
      <div className="flex flex-col items-center min-h-screen px-6 py-12">
        {state === "pre" && (
          <>
            ...
            <p className="font-body font-light text-[15px] text-foreground/65 text-center max-w-[300px] mt-4 leading-relaxed">
            ...
            <button onClick={startRecording} className="w-20 h-20 rounded-full bg-primary flex items-center justify-center mt-10 active:scale-[0.97] transition-transform shadow-lg">
        ...
        {state === "recording" && (
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <button onClick={stopRecording} className="w-20 h-20 rounded-full border-2 border-red-400 animate-breathe flex items-center justify-center active:scale-[0.97] transition-transform">

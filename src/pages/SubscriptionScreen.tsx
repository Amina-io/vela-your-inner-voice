  ...
  return (
    <MobileShell className="bg-background bg-ambient">
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="w-full py-2.5 px-4 text-center border-b" style={{ background: 'rgba(201,169,110,0.15)', borderColor: 'rgba(201,169,110,0.4)' }}>
        ...
        <div className="flex flex-col items-center px-6 pt-8 pb-12">
          <h2 className="font-display text-[28px] text-foreground text-center">{userName}, your subliminal is ready.</h2>
          ...
          <div className="flex flex-col gap-3 w-full mt-8">
            ...
            <button onClick={() => navigate("/home")} className="font-body font-light text-[13px] text-muted-foreground text-center">

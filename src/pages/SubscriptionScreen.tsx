    ...
    <MobileShell className="bg-background bg-ambient">
      ...
      <div className="flex flex-col min-h-screen screen-enter relative z-10">
        ...
        <div className="flex flex-col items-center px-6 pt-8 pb-12">
          <h2 className="font-script text-[30px] text-foreground text-center">{userName}, your subliminal is ready.</h2>
          ...
          <div className="flex flex-col gap-3 w-full mt-8">
            ...
            <button onClick={() => navigate("/home")} className="font-body font-light text-[13px] text-muted-foreground text-center transition-opacity duration-200 ease-out active:opacity-70">
